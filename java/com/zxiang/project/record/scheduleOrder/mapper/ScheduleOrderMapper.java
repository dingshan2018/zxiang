package com.zxiang.project.record.scheduleOrder.mapper;
...
public interface ScheduleOrderMapper 
{
     ...
     * @return 结果
     */
	public int deleteScheduleOrderById(Integer scheduleOrderId);
	
	/**
     * 批量删除排期订单
     * 
     * @param scheduleOrderIds 需要删除的数据ID
     * @return 结果
     */
	public int deleteScheduleOrderByIds(String[] scheduleOrderIds);
