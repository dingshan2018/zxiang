package com.zxiang.framework.shiro.service;
...
import com.zxiang.common.utils.MessageUtils;
import com.zxiang.common.utils.ServletUtils;
import com.zxiang.common.utils.security.ShiroUtils;
import com.zxiang.framework.manager.AsyncManager;
import com.zxiang.framework.manager.factory.AsyncFactory;
import com.zxiang.project.system.user.domain.User;
import com.zxiang.project.system.user.domain.UserStatus;
...
public class LoginService
{
     ...
     * 登录
     */
    public User login(String username, String password ,String openId)
    {
        ...
        if(StringUtil.isBlank(openId)) {//如果openId有值进行免密登陆
