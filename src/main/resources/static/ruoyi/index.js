...
// 顶部公司名称处理
(function () {
  var headerBrand = document.querySelector(".navbar-header .navbar-brand");
  if (headerBrand.scrollWidth > headerBrand.offsetWidth) {
    headerBrand.style.paddingTop = 0;
    headerBrand.style.paddingBottom = 0;
    headerBrand.style.whiteSpace = 'normal';
  }
...
$(function () {
  ...
  function scrollToTab (element) {
    ...
    if ($(".page-tabs-content").outerWidth() < visibleWidth) {
      ...
      (visibleWidth - $(element).outerWidth(true) - $(element).prev().outerWidth(true))) {
  ...
  function scrollTabLeft () {
    ...
    if ($(".page-tabs-content").width() < visibleWidth) {
      ...
      if (calSumWidth($(tabElement).prevAll()) > visibleWidth) {
        while ((offsetVal + $(tabElement).outerWidth(true)) < (visibleWidth) && tabElement.length >
        0) {
          offsetVal += $(tabElement).outerWidth(true);
          tabElement = $(tabElement).prev();
        }
