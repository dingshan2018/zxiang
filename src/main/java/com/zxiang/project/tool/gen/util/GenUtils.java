package com.zxiang.project.tool.gen.util;

import java.util.ArrayList;
import java.util.List;
import org.apache.velocity.VelocityContext;

import com.zxiang.common.constant.CommonMap;
...
{
    /** 项目空间路径 */
    private static final String PROJECT_PATH = "main/java/com/zxiang/project";
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println(getModuleName("com.zxiang.project.system"));
    }
}
