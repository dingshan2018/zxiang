...
public class Const {
	 ...
	 * 资金流水类型：1:充值
	 */
	public static String FUND_TOP_UP = "1";
	/**
	 * 资金流水类型：2:广告付费
	 */
	public static String FUND_AD_PAY = "2";
	/**
	 * 资金流水类型：3:提现
	 */
	public static String FUND_WITHDRAW_DEPOSIT = "3";
	/**
	 * 资金流水类型：4:收益
	 */
	 ...
	 * 资金流水类型：6:回账
	 */
	public static String FUND_BACK = "6";
	/**
	 * 提现状态 1：提现中
	 */
